<?php
    ...
    if(isset($_POST['search'])){
        ...
        $e = $_POST['keyword'];
        $query = mysqli_query($conn, "SELECT * FROM appoinment WHERE no_antrian LIKE '%$e%' OR nama LIKE '%$e%' OR email LIKE '%$e%' OR no_telp LIKE '%$e%' OR tanggal LIKE '%$e%' HAVING tanggal >= '$date' ");
    }

    else{
        $query = mysqli_query($conn, "SELECT * FROM appoinment WHERE tanggal >= '$date' ORDER BY id DESC");
    }
...
<body>
    ...
    <style>
        ...
        @media(min-width:991px){
            .navbar{border-radius:10px;}.navbar-nav .btn:hover{box-shadow:none;}.navbar-nav{margin-top: -300px}}
    </style>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody align="center">
                                    ...
                                    <td><?= $sql['spesialis'] ?></td>
                                    <td><?= $sql['tanggal'] ?></td>
                                    <td><a href="edit.php?id=<?=$sql['id']?>" class="btn btn-success btn-sm">EDIT</a>
