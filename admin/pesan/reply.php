...
<body>
    ...
    <style>
        ...
        .bg-header .btn:hover{color:#fff;}            
    </style>

    <div class="dashboard">
        <div class="row">

            <div class="bg col-12 col-lg-2">
                ...
                <div class="bg-header pt-4 mb-4">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col">
                                <a href="view.php" class="btn text-uppercase tombol float-right">Back to List</a>
                            </div>
                ...
                <div class="col-12">
                    ...
                    <form action="process/reply-process.php" method="POST">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <textarea name="pesan" class="form-control" placeholder="Messages" id="" cols="30" rows="10"></textarea>
                                </div>
                            </div>

                            <div class="col-12">
                                <button type="submit" class="btn mt-5 w-100 btn-rounded btn-success text-uppercase tombol">send</button>
                            </div>
