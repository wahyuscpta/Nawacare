                ...
                <div class="col-12">
                    <div class="bg-content edit">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <select name="spesialis" id="" placaeholder="Spesialis" class="form-control">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <select name="jk" placaeholder="Jenis Kelamin" class="form-control">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <textarea name="alamat" placeholder="Alamat" cols="30" rows="10" class="form-control"></textarea>
                                </div>
                            </div>                            
