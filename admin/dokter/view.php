<?php
    ...
    if(isset($_POST['search'])){
        ...
        $query = mysqli_query($conn, "SELECT * FROM dokter WHERE nama LIKE '%$a%' OR spesialis LIKE '%$a%' OR jenis_kelamin LIKE '%$a%' ");
    }
    else{
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        ...
                        <a class="navbar-brand brand-two" href="#">Nawacare</a>
                            ...
                            <a class="nav-item nav-link active" href="view.php">Doctor</a>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg">
                                <a href="tambah.php" class="btn btn-success btn-block text-uppercase add tombol">Add Doctor</a>
                            </div>
