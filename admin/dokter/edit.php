                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            ...
                            <a class="nav-item nav-link active" href="view.php">Dokter</a>
                ...
                <div class="col-12">
                    <div class="bg-content edit">
                        ...
                        <form action="process/edit-process.php" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="hidden" value="<?=$sql['id']?>" name='id'>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <select name="spesialis" id="" placaeholder="Spesialis" class="form-control"  value="<?=$sql['spesialis']?>">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <select name="jk" id="" placaeholder="Spesialis" class="form-control" value="<?=$sql['jenis_kelamin']?>" >
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <input name="alamat" placeholder="Alamat" class="form-control" value="<?=$sql['alamat']?>">
                                </div>
                            </div>                            
