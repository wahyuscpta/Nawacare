<?php
    ...
    if(isset($_POST['search'])){
        ...
        $query = mysqli_query($conn, "SELECT * FROM berita WHERE judul LIKE '%$a%' OR tanggal LIKE '%$a%' ");
    }
    else{
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg">
                                <a href="tambah.php" class="btn btn-success btn-block text-uppercase add tombol">Add News</a>
                            </div>
