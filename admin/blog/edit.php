...
<body>
    ...
    <div class="dashboard">
        <div class="row">
            ...
            <div class="col-12 col-lg-10 pl-5">
                ...
                <div class="col-12">
                    <div class="bg-content edit">
                        ...
                        <form action="process/edit-process.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Judul Berita" name="judul" value="<?=$sql['judul']?>">
                                </div>
                            </div>
    
                            <div class="col-12">
                                <div class="form-group">
                                    <textarea name="isi" class="form-control" placeholde="Isi Berita" cols="30" rows="10"><?=$sql['isi']?></textarea>
                                </div>
                            </div>
